...
<head>
    ...
    <style>
        ...
        .val { font-size: 16px; font-weight: 600; color: #334155; margin-top: 4px; }

        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        th { text-align: left; padding: 12px; background: #1e293b; color: white; font-size: 13px; text-transform: uppercase; }
        ...
        .tag-goodwill { background: #ffedd5; color: #c2410c; }
